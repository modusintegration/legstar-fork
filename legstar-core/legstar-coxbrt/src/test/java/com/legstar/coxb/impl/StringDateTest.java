...
public class StringDateTest extends TestCase {
    ...
    public void testDateToHost() throws Exception {
        ...
        ccem.accept(mv);
        //FIXME Ignored because this string is harcoded to the France Location, so it expects 8 as its hour but in GMT-3 is 3
...
//                HostData.toHexString(hostBytes));
    ...
    public void testHostToDate() throws Exception {
        ...
        //FIXME Ignored because this string is harcoded to the France Location, so it expects CEST but we can have anything as in GMT-3
